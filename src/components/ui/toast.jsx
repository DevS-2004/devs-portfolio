...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed z-[100] flex flex-col-reverse p-4 w-full max-w-sm sm:max-w-md left-1/2 -translate-x-1/2 bottom-4 sm:left-auto sm:translate-x-0 sm:bottom-0 sm:right-0 sm:top-auto",
      className
    )}
    {...props}
  />
